...
//   node record-gifs.js signals     → one job (or "tour")
...
const HTML = path.resolve(__dirname, '..', 'lecture-51-auth.html').replace(/\\/g, '/');
...
const JOBS = [
  ...
  { name: 'interceptor',        slide: 9,  sel: ['.icp'],               dur: 5,    fig: true },
  { name: 'silent-refresh',     slide: 11, sel: ['.sr-btn', '#srFig'],  dur: 14 },
  { name: 'signals',            slide: 12, sel: ['.sig'],               dur: 6,    fig: true },
